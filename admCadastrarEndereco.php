    ...
    <section class="areaEstilizada">
        ...
        <div class="areaAltEnd">
            <div class="tituloTopoArea">
                <div class="textoTopo">
                    <a class="setaVoltar" href="admEndereco.php">
                    ...
                    <p class="tituloCadastro">CADASTRO ENDEREÇO</p>
                </div>
            </div>
            <div class="areaAltEndCaixa">

                <form action="enderecos/criarEndereco.php" class="endLoja" method="post" enctype="multipart/form-data">
