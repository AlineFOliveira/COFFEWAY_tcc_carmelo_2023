...
$sqlClienteInfo = "SELECT * FROM cliente WHERE id= $id_cliente LIMIT 1 ";
$resultClienteInfo = mysqli_query($conexao, $sqlClienteInfo);

$row = mysqli_fetch_assoc($resultClienteInfo);
        ...
        <div class="carrinhoArea">
            ...
            <div class="clienteCaixa">
                ...
                <div class="clienteBotoesArea">
                    <form action="editarClienteLogin.php" method="post">
                      <input type="hidden" name="id_cliente" value="<?php echo $id_cliente; ?>">
                      <input class="clienteBotaoEditar" name="clienteEditar" type="submit" value="Editar">
                    </form>
