...
$sqlListarCliente = "SELECT id, nome_completo, cpf, endereco, telefone FROM cliente";
$resultListarCliente = mysqli_query($conexao, $sqlListarCliente);

$sqlEmailCliente = "SELECT email FROM login";
$resultListarEmailCliente = mysqli_query($conexao, $sqlEmailCliente);
?>
    ...
    <section class="areaEstilizada">
        <div class="menuAdmArea">
            ...
            <div class="tituloTopoArea">
                <div class="textoTopo">
                    <a class="setaVoltar" href="admClientes.php">
                    ...
                    <p class="tituloCadastro">LISTAR CLIENTES</p>
                </div>
            </div>
            ...
            <section class="listarEnderecoArea">
                ...
                <div class="listarEnderecoCaixa">
                    ...
                    $emailRow = mysqli_fetch_assoc($resultListarEmailCliente);
                    $email = $emailRow['email'];
                    // Loop para percorrer os resultados da consulta
                    while ($row = mysqli_fetch_assoc($resultListarCliente)) {
                        $id = $row['id'];
