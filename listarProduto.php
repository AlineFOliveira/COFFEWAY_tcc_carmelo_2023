...
// Consulta SQL para buscar informações dos produtos
    ...
    <section class="areaEstilizada">
        <div class="menuAdmArea">
            ...
            <div class="tituloTopoArea">
                <div class="textoTopo">
                    <a class="setaVoltar" href="admProdutos.php">
                    ...
                    <p class="tituloCadastro">LISTAR PRODUTOS</p>
                </div>
            </div>

            <section class="listarProdutoArea">

                <div class="listarProdutoCaixa">
                    <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $preco = $row['preco'];
                    ?>
                        <div class="listarProdutoCaixas">
                            <div class="listarProdutoDesc">
                                <h3><?php echo $nome; ?></h3>
                                <p><?php echo $descricao; ?></p>
                                <h3>R$<?php echo number_format($preco, 2, ',', '.'); ?></h3>
                            </div>
                            <div class="listarProdutoBotoes">
                                <form action="admEditarProduto.php?idProduto=<?php echo $idProduto; ?>" method="get">

                                    <input type="hidden" name="idProduto" value="<?php echo $idProduto; ?>">
                                    <input class="listarProdutoEditar" name="EditarProduto" type="submit" value="EDITAR">
                                </form>


                                <form action="produtos/excluirProduto.php?idProduto=<?php echo $idProduto; ?>" method="get">

                                    <input type="hidden" name="idProduto" value="<?php echo $idProduto; ?>">
                                    <input class="listarProdutoExcluir" name="ExcluirProduto" type="submit" value="EXCLUIR">
                                </form>
