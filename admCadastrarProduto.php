    ...
    <section class="areaEstilizada">
        ...
        <div class="tituloTopoArea">
            ...
            <div class="areaCadastroCaixa">
                ...
                <form action="Produtos/criarProduto.php" class="admCadastros" method="post" enctype="multipart/form-data">
                    <label>Nome do Produto</label>
                    <input type="text" name="nome" required>

                    <label>Descrição</label>
                    <textarea name="descricao" id="descProduto" cols="30" rows="10"></textarea>
                    ...
                    <div class="wrapper">
                        ...
                        <input type="submit" class="btnCadAdm" name="acao" value="Concluir">
